        ...
        <div class="row p-5">
            <form action="./includes/logic.php" method="post">
                ...
                <div class="form-group">
                    <label for="log_phone">Phone</label>
                    <input type="text" class="form-control" name="log_phone" id="log_phone" aria-describedby="emailHelp" placeholder="Enter Phone">
                    <small id="emailHelp" class="form-text text-muted">Keep your password safe</small>
                </div>
                <div class="form-group">
